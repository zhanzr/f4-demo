# Shared STM32F429IGT6 board layer for the apollo-f429 board projects.
...
function(stm32f429_apply_board TGT OPT)
    ...
    target_sources(${TGT} PRIVATE
        ...
        ${STM32F4_HAL_SRC}/stm32f4xx_hal_dcmi.c
        ${STM32F4_HAL_SRC}/stm32f4xx_hal_tim.c
        ${STM32F4_HAL_SRC}/stm32f4xx_hal_tim_ex.c
        ${STM32F4_HAL_SRC}/stm32f4xx_hal_ltdc.c
        ${STM32F4_HAL_SRC}/stm32f4xx_hal_ltdc_ex.c
    ...
    if(STM32_STARM_CLANG)
        ...
        set(_LDFLAGS "${_LDFLAGS} -Xlinker -T -Xlinker ${STM32_LINKER_SCRIPT}")
        ...
        set(_LDFLAGS "${_LDFLAGS} -T ${STM32_LINKER_SCRIPT}")
