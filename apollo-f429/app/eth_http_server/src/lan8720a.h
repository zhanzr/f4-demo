/**
  ...
  * @brief   Minimal LAN8720A 10/100 Ethernet PHY driver for the apollo-f429
...
/* Pulse the hardware reset (PCF8574 P7 ETH_RESET, inverted through Q1) then
 * soft-reset the PHY and enable auto-negotiation. Returns 0 on success
 * (MDIO responding), non-zero if the PHY does not answer. */
