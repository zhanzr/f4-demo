# Dhrystone 2.1 @ 180 MHz — apollo-f429 (STM32F429IGT6)

Classic Dhrystone 2.1 (dhry_1.c / dhry_2.c / dhry.h), **2,000,000 runs**, on
the **apollo-f429** board (STM32F429IGT6, bare metal) clocked at **180 MHz**
...
| ------------ | ------------------------------------------ | ------------ | --------- |
| GCC 15.3.1   | `-Ofast -ffp-contract=fast -funroll-loops` | 386,175      | 1.221     |
