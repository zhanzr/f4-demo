...
void Board_SDRAM_EarlyInit(void)
{
    ...
    /* W9825G6KH: 32 MiB, 16-bit, FMC bank 1 @ 0xC0000000.
     * Matches the proven config in bare/sdram_test (13-row A0-A12, 9-col,
     * CAS3, mode register 0x0230, refresh 683). */
    ...
    sdram_command.AutoRefreshNumber = 1;
    sdram_command.ModeRegisterDefinition = 0x0230U;
    (void)HAL_SDRAM_SendCommand(&sdram_handle, &sdram_command, HAL_MAX_DELAY);
    (void)HAL_SDRAM_ProgramRefreshRate(&sdram_handle, 683U);
}
