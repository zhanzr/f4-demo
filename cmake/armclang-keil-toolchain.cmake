...
# linker script (stm32f407vet6.ld), newlib-based syscalls.c and the ST startup
...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} --target=arm-arm-none-eabi -mcpu=cortex-m4")
...
# Tells cmake/stm32f407_board.cmake to apply armclang-specific tweaks
