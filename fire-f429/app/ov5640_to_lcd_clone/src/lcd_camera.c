/**
  * @file    ov5640_to_lcd_clone/src/lcd_camera.c
  ...
  * Board_SDRAM_EarlyInit() (8-col/12-row/CAS2, read-burst ON) - the vendor's
  * read-burst-off config starves the LTDC FIFO and smears the image.
  */
...
/* ------------------------------------------------------------------ */
/* LTDC pin muxing (identical to board/board_ltdc.c: no PG11/B3,       */
/* NOPULL, VERY_HIGH speed).                                           */
