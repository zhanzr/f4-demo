/**
  * @file    ov5640_to_lcd_clone/src/lcd_camera.h
  ...
  * (Board_SDRAM_EarlyInit, 8-col/12-row/CAS2 with read-burst enabled) - the
  * vendor's read-burst-disabled config starves the LTDC FIFO and smears the
  * image horizontally (see README).
  */

#ifndef FIRE_F429_OV5640_CLONE_LCD_CAMERA_H
#define FIRE_F429_OV5640_CLONE_LCD_CAMERA_H
...
#endif /* FIRE_F429_OV5640_CLONE_LCD_CAMERA_H */
