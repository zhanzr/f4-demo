...
/* Display-oriented variant: returns the NEWEST complete RGB565 frame
 * (skipping any older ones), never stalling on ring wrap-around. Use this
 * for a live view where dropping frames is fine and latency matters.
 * Returns 1 and sets *frame, or 0 before the first frame is complete. */
