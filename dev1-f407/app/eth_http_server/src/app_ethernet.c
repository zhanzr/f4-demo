...
/* Bring up the HTTP listener once an IP is available (DHCP or static). */
...
/**
  ...
  *
  * Report-only: ethernet_link_check_state() no longer stops/starts the
  * MAC (that caused the flapping). It just tracks link up/down for the
  * lwIP link callback.
  */
