/**
  ...
  *
  * ADC1 on APB2 (84 MHz with the 168 MHz clock tree). The ADC clock is
  * PCLK2/4 = 21 MHz (within the 36 MHz max for F407). A single scan converts
  * the three internal channels in sequence (12-bit, right-aligned).
  */
