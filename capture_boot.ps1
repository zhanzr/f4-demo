# Capture eth_http_server boot log: open COM36, reset target via OpenOCD, print 8s of serial.
...
$outfile = 'd:\f4-demo\boot_log.txt'
$tmpfile = 'd:\f4-demo\boot_log_tmp.txt'
Remove-Item $tmpfile -ErrorAction SilentlyContinue

$job = Start-Job -ArgumentList $tmpfile {
    param($tf)
    $p = [System.IO.Ports.SerialPort]::new('COM36', 115200, [System.IO.Ports.Parity]::None, 8, [System.IO.Ports.StopBits]::One)
    $p.ReadTimeout = 6000
    $p.Open()
