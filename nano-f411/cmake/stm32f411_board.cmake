# Shared STM32F411CEU6 board layer for the "nano-f411" board projects.
# The board support (clock init to 100 MHz from the 25 MHz HSE crystal, LED GPIO,
# SWV/ITM enable, newlib stubs, startup, linker script) plus the STM32F4 HAL
# driver sources are attached to a target with stm32f411_apply_board().
#
# Usage (from a project CMakeLists.txt, after add_executable()):
#   include(${CMAKE_CURRENT_SOURCE_DIR}/../../cmake/stm32f411_board.cmake)
#   stm32f411_apply_board(${PROJECT_NAME}.elf "-Ofast")
#
...
function(stm32f411_apply_board TGT OPT)
    ...
    target_sources(${TGT} PRIVATE
        ...
        ${BOARD_DIR}/startup_stm32f411xx.s
    ...
    target_compile_definitions(${TGT} PRIVATE STM32F411xE USE_HAL_DRIVER)
