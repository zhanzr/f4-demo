...
| `app/ili9163c_md144_128x128` | **ILI9163C 1.44" 128x128** LCD (MD144 connector, **no D/C pin**: 3-wire serial, 9-bit frames on soft SPI; **backlight hardwired on**) - same pattern set (SCL=PA5 SDA=PA7 RES=PA6 CS=PB8) |
