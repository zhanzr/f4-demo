...
| `app/st7365_md350_320x480` | **ST7365P 3.5" 320x480** LCD (MD350, MADCTL 0x48 portrait) via 4-wire soft SPI (SCL=PA5 SDA=PA7 **RES=PA3** DC=PA4 CS=PB8 BL=PB9; **MISO=PA6** unused by the write-only driver) - same pattern set |
