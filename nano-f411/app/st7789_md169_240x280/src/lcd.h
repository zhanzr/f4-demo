/*
  lcd.h - ST7789V/T3 1.69" 240x280 LCD driver (nano-f411 port, MD169).
  Same drawing API as the st7735_md144_128x128 baseline (24-bit colors,
  ...
  Panel geometry: ST7789 240x320 GRAM, 240x280 glass -> ROW_Pre = 20
  (glass covers GRAM rows 20..299, verified on the c542 board), MADCTL 0x00.
*/
