/*
  lcd.c - ST7789V 1.3" 240x240 LCD driver (nano-f411 port, MD130 module).
  ST7789V init sequence and the standard 4-wire serial drawing API:
    - MADCTL 0x00, IPS inversion (INVON), 16bpp COLMOD,
    - ST7789 power/porch/gamma init,
    - 240x240 glass at GRAM rows 0..239 -> COL_Pre = 0, ROW_Pre = 0.
  Wiring: SCL=PA5, SDA=PA7, RES=PA6, DC=PA4, CS=PB8, BL=PB9 (TIM4_CH4 PWM).
*/
...
/* =====================================================================
   Init sequence - ST7789V: power/porch/gamma registers specific to the
   ST7789, IPS inversion (INVON), MADCTL 0x00 and 16bpp COLMOD.
   ===================================================================== */
...
/* =====================================================================
   ...
   drawing API, adapted to the 240x240 ST7789V.
   ===================================================================== */
