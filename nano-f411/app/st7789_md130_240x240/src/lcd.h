/*
  lcd.h - ST7789V 1.3" 240x240 LCD driver (nano-f411 port, MD130).
  ...
  Panel geometry: ST7789 240x320 GRAM, 240x240 glass at GRAM rows 0..239 ->
  COL_Pre = 0, ROW_Pre = 0 (a nonzero row offset shifts every window down
  and leaves a blank band at the top of the glass), MADCTL 0x00.
*/
