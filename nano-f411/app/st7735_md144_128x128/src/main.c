/*
  st7735_md144_128x128 main for the nano-f411 (STM32F411CEU6 @ 100 MHz).
  Test patterns ported from the c542 board_t1 st7789_md130_240x240 demo
  (bsp/st7789/main.c), adapted to the 128x128 ST7735S panel:
...
/* Info page (ported from the md130 demo): compiler, build date, current
   ...
   Reformatted for 128 px: max 21 chars per line with the 6x12 font, and
   no ADC block (this board's baseline has no adc_internal helper).      */
