/*
  ...
  at runtime:
    ...
    HW  : PA5/PA7 re-muxed to SPI1 AF5 (SCK/MOSI), master, simplex TX
          ...
          APB2 = 50 MHz: default prescaler /4 = 12.5 MHz (in-spec for
          ST7735S, ~50x the bit-bang); set LCD_SPI1_PRESC to
          SPI_BAUDRATEPRESCALER_2 for 25 MHz if the module tolerates it.
...
/* SPI1 baud prescaler: APB2 = 50 MHz. /4 = 12.5 MHz (ST7735S in-spec);
 * /2 = 25 MHz (fastest, out-of-spec but often tolerated by modules). */
