/**
  ...
  * @brief   HAL configuration file for STM32F411CEU6 (nano-f411 board).
...
/* ########################## Oscillator Values ############################# */
#define HSE_VALUE    ((uint32_t)25000000U) /*!< Value of the External oscillator in Hz. nano-f411 board: 25 MHz. */
