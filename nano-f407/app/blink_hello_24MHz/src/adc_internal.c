/**
  ...
  *
  * ADC1 on APB2. The ADC clock is PCLK2/4: at the default 168 MHz tree that is
  * 84/4 = 21 MHz; at this project's 24 MHz tree it is 24/4 = 6 MHz (both well
  * within the 36 MHz max for F407). A single scan converts the three internal
  * channels in sequence (12-bit, right-aligned).
  */
